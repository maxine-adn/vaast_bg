...
***************************************************************/
 ...
 jsPsych.plugins['vaast-image'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html_str += "<div style='position:absolute;right:50%;top:50;width:"+trial.font_sizes[trial.position]+"px; height:"+trial.font_sizes[trial.position]+"px;margin-top:-"+(trial.font_sizes[trial.position]/2)+"px;margin-right:-"+(trial.font_sizes[trial.position]/2)+"px'><img height='"+trial.font_sizes[trial.position]+"' width='"+trial.font_sizes[trial.position]+"' src='"+trial.stimulus+"' id='jspsych-vaast-stim'></img></div>";
